...
function getSummaryData() {
	...
	summaryData += '{"category":"","totalData":"' + "" + '","state1Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=1&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出" + "</a>" + '","state2Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=2&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出" + "</a>" + '","state3Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出" + "</a>" + '","state4Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=4&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出" + "</a>" + '","hangupCause1Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=1&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause16Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=16&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause19Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=19&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause34Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=34&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause38Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=38&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause401Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=401&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause402Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=402&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '","hangupCause403Data":"' + "<a href='autoCallTaskTelephone/exportExcel?taskId=" + currTaskId + "&state=3,4&hangupCause=403&isSearchHistoryCallTask=" + isSearchHistoryCallTask + "'>导出</a>" + '"}';
	summaryData += "]}";
...
function reloadStatistics() {
	...
	$.ajax({
		...
		url:'autoCallTask/reloadStatistics?taskId=' + currTaskId + '&isSearchHistoryCallTask=' + isSearchHistoryCallTask,
		method:'post',
		dataType:'json',
		success:function(rs) {
