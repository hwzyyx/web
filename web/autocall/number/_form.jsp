		...
		<form id="uploadTelephoneForm" method="post" enctype="multipart/form-data">
			<table id="formTable" border="0" cellspacing="0" cellpadding="0" bordercolor="#c4e1ff" width="680"
				...
				<tr>
					...
					<td>
						下载模板：<a href="autoNumber/template?type=txt">TXT</a>&nbsp;|&nbsp;<a href="autoNumber/template?type=excel">EXCEL</a>
					</td>
					<td>
...
<div id="telephoneopertool" style="padding:5px;">
	...
	<span style="padding-left:630px;">
		<a href="#" id="easyui-export" onclick="autoNumberTelephoneExport()" class="easyui-linkbutton" iconCls='icon-redo' plain="true">导出号码</a>
	</span>
</div>
