...
function lastCallResult2DataFormatter(value,data,index) {
	if(value=="导出") {
		...
		return "<span style='color:#f10303;font-weight:bolder;'>" + value + "</span>"; 
	}
}
	...
	<table id="summaryDg" data-options="fit:true,singleSelect:true,rownumbers:false">
		<thead>
			<tr style="font-weight: bold;">
				...
				<th data-options="field:'state1Data',width:115,align:'center',formatter:state1DataFormatter,styler:stateStyler">已载入</th>
				<th data-options="field:'state2Data',width:115,align:'center',formatter:state2DataFormatter,styler:stateStyler">已成功</th>
				<th data-options="field:'state3Data',width:115,align:'center',formatter:state3DataFormatter,styler:stateStyler">待重呼</th>
				<th data-options="field:'state4Data',width:115,align:'center',formatter:state4DataFormatter,styler:stateStyler">已失败</th>
