...
public class SysScheduleController extends Controller implements IController {
	...
	@Override
	public void add() {
		SysSchedule schedule = getModel(SysSchedule.class, "schedule");
		...
		boolean b = SysSchedule.dao.add(schedule);
	...
	public void datagrid() {
		...
		Map map = SysSchedule.dao.getScheduleByPaginateToMap(pageNumber,pageSize,scheduleName,dateType,orgCode);
	...
	/**
	 * 查询数据，根据当前登录用户分配到的调度任务返回，如果当前没有被分配到调度任务，则返回空
	 */
	public void datagridByScheduleAssign() {
		
		String currOperId = (String) getSession().getAttribute("currOperId");   //当前登录的操作员
		...
		Map map = SysSchedule.dao.getScheduleByPaginateToMapByScheduleAssign(pageNumber,pageSize,scheduleName,dateType,orgCode,currOperId);
	...
	public void getCombobox() {
		...
		List<Record> list = SysSchedule.dao.getAllSchedules();
	...
	public void delete() {
		...
		boolean b = SysSchedule.dao.deleteByScheduleId(scheduleId);
	...
	public void getSchedule() {
		...
		SysSchedule schedule = SysSchedule.dao.getScheduleById(scheduleId);
	...
	public void update() {
		...
		boolean b = SysSchedule.dao.update(schedule);
